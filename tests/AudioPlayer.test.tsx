...
import AudioPlayer, { AudioPlayerProps } from '../app/components/audio-player/AudioPlayer';
...
describe('AudioPlayer Component', () => {
    ...
    it('does not play audio if play fails and logs error', async () => {
        ...
        const audioPlayMock = vi.fn().mockRejectedValue(new Error('Failed to play'));
        ...
        expect(consoleErrorSpy).toHaveBeenCalledWith('Failed to play the audio:', expect.any(Error));
