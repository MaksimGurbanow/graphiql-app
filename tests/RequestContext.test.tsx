...
describe('RequestContext', () => {
    it('should throw an error when useRequestContext is used outside of a provider', () => {
        const TestComponent = () => {
            try {
                ...
                expect(error.message).toBe('setRest or setGraphql should be used within a provider');
            }
            return null;
        };
    ...
    it('should update rest state correctly', () => {
        ...
        expect(screen.getByTestId('rest-url')).toHaveTextContent('https://example.com');
    });
    ...
    it('should update graphQL state correctly', () => {
        ...
        expect(screen.getByTestId('graphql-url')).toHaveTextContent('https://graphql.com');
    });
});
